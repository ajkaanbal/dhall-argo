< Any : ./types/google.protobuf.Any.dhall
| StreamError : ./types/grpc.gateway.runtime.StreamError.dhall
| ArchiveStrategy : ./types/io.argoproj.workflow.v1alpha1.ArchiveStrategy.dhall
| ArchivedWorkflowDeletedResponse :
    ./types/io.argoproj.workflow.v1alpha1.ArchivedWorkflowDeletedResponse.dhall
| Arguments : ./types/io.argoproj.workflow.v1alpha1.Arguments.dhall
| Artifact : ./types/io.argoproj.workflow.v1alpha1.Artifact.dhall
| ArtifactLocation :
...
| Backoff : ./types/io.argoproj.workflow.v1alpha1.Backoff.dhall
| Cache : ./types/io.argoproj.workflow.v1alpha1.Cache.dhall
...
| Condition : ./types/io.argoproj.workflow.v1alpha1.Condition.dhall
| ContinueOn : ./types/io.argoproj.workflow.v1alpha1.ContinueOn.dhall
| Counter : ./types/io.argoproj.workflow.v1alpha1.Counter.dhall
| CreateCronWorkflowRequest :
    ./types/io.argoproj.workflow.v1alpha1.CreateCronWorkflowRequest.dhall
| CronWorkflow : ./types/io.argoproj.workflow.v1alpha1.CronWorkflow.dhall
...
| DAGTask : ./types/io.argoproj.workflow.v1alpha1.DAGTask.dhall
| DAGTemplate : ./types/io.argoproj.workflow.v1alpha1.DAGTemplate.dhall
| EventResponse : ./types/io.argoproj.workflow.v1alpha1.EventResponse.dhall
| ExecutorConfig : ./types/io.argoproj.workflow.v1alpha1.ExecutorConfig.dhall
| GCSArtifact : ./types/io.argoproj.workflow.v1alpha1.GCSArtifact.dhall
| Gauge : ./types/io.argoproj.workflow.v1alpha1.Gauge.dhall
| GetUserInfoResponse :
...
| Item : ./types/io.argoproj.workflow.v1alpha1.Item.dhall
| Link : ./types/io.argoproj.workflow.v1alpha1.Link.dhall
| LintCronWorkflowRequest :
    ./types/io.argoproj.workflow.v1alpha1.LintCronWorkflowRequest.dhall
| LogEntry : ./types/io.argoproj.workflow.v1alpha1.LogEntry.dhall
| MemoizationStatus :
    ./types/io.argoproj.workflow.v1alpha1.MemoizationStatus.dhall
| Memoize : ./types/io.argoproj.workflow.v1alpha1.Memoize.dhall
| Metadata : ./types/io.argoproj.workflow.v1alpha1.Metadata.dhall
| MetricLabel : ./types/io.argoproj.workflow.v1alpha1.MetricLabel.dhall
| Metrics : ./types/io.argoproj.workflow.v1alpha1.Metrics.dhall
| Mutex : ./types/io.argoproj.workflow.v1alpha1.Mutex.dhall
| MutexHolding : ./types/io.argoproj.workflow.v1alpha1.MutexHolding.dhall
| MutexStatus : ./types/io.argoproj.workflow.v1alpha1.MutexStatus.dhall
| NodeStatus : ./types/io.argoproj.workflow.v1alpha1.NodeStatus.dhall
| NodeSynchronizationStatus :
    ./types/io.argoproj.workflow.v1alpha1.NodeSynchronizationStatus.dhall
| NoneStrategy : ./types/io.argoproj.workflow.v1alpha1.NoneStrategy.dhall
| OSSArtifact : ./types/io.argoproj.workflow.v1alpha1.OSSArtifact.dhall
| Outputs : ./types/io.argoproj.workflow.v1alpha1.Outputs.dhall
| ParallelSteps : ./types/io.argoproj.workflow.v1alpha1.ParallelSteps.dhall
| Parameter : ./types/io.argoproj.workflow.v1alpha1.Parameter.dhall
| PodGC : ./types/io.argoproj.workflow.v1alpha1.PodGC.dhall
| Prometheus : ./types/io.argoproj.workflow.v1alpha1.Prometheus.dhall
| RawArtifact : ./types/io.argoproj.workflow.v1alpha1.RawArtifact.dhall
| ResourceTemplate :
    ./types/io.argoproj.workflow.v1alpha1.ResourceTemplate.dhall
| RetryStrategy : ./types/io.argoproj.workflow.v1alpha1.RetryStrategy.dhall
| S3Artifact : ./types/io.argoproj.workflow.v1alpha1.S3Artifact.dhall
| ScriptTemplate : ./types/io.argoproj.workflow.v1alpha1.ScriptTemplate.dhall
| SemaphoreHolding :
    ./types/io.argoproj.workflow.v1alpha1.SemaphoreHolding.dhall
| SemaphoreRef : ./types/io.argoproj.workflow.v1alpha1.SemaphoreRef.dhall
| SemaphoreStatus : ./types/io.argoproj.workflow.v1alpha1.SemaphoreStatus.dhall
| Sequence : ./types/io.argoproj.workflow.v1alpha1.Sequence.dhall
| Submit : ./types/io.argoproj.workflow.v1alpha1.Submit.dhall
| SubmitOpts : ./types/io.argoproj.workflow.v1alpha1.SubmitOpts.dhall
| SuppliedValueFrom :
    ./types/io.argoproj.workflow.v1alpha1.SuppliedValueFrom.dhall
| SuspendTemplate : ./types/io.argoproj.workflow.v1alpha1.SuspendTemplate.dhall
| Synchronization : ./types/io.argoproj.workflow.v1alpha1.Synchronization.dhall
| SynchronizationStatus :
    ./types/io.argoproj.workflow.v1alpha1.SynchronizationStatus.dhall
| TTLStrategy : ./types/io.argoproj.workflow.v1alpha1.TTLStrategy.dhall
| TarStrategy : ./types/io.argoproj.workflow.v1alpha1.TarStrategy.dhall
| Template : ./types/io.argoproj.workflow.v1alpha1.Template.dhall
| TemplateRef : ./types/io.argoproj.workflow.v1alpha1.TemplateRef.dhall
...
| WorkflowList : ./types/io.argoproj.workflow.v1alpha1.WorkflowList.dhall
...
| WorkflowSpec : ./types/io.argoproj.workflow.v1alpha1.WorkflowSpec.dhall
| WorkflowStatus : ./types/io.argoproj.workflow.v1alpha1.WorkflowStatus.dhall
| WorkflowStep : ./types/io.argoproj.workflow.v1alpha1.WorkflowStep.dhall
| WorkflowStopRequest :
...
| WorkflowTemplateSpec :
    ./types/io.argoproj.workflow.v1alpha1.WorkflowTemplateSpec.dhall
